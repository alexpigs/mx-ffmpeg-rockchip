#ifndef __DMA_ALLOCATOR_H__
#define __DMA_ALLOCATOR_H__
...
static inline int dma_sync_device_to_cpu(int fd) {
...
static inline int dma_sync_cpu_to_device(int fd) {
  struct dma_buf_sync sync = {0};
...
static inline int dma_buf_alloc(const char *path, size_t size, int *fd,
                                void **va) {
  int ret;
  int prot;
  void *mmap_va;
...
static inline void dma_buf_free(size_t size, int *fd, void *va) {
  int len;
...
#endif /* __MXCAMENC_DMA_ALLOCATOR_H__ */